...
class DataLoader:
    ...
    def init_vocab(self, data):
        ...
        pos_data = [d[3] for d in data]
        # pos_data = [d[1] + '|' + d[3] for d in data]
        # pos_data_alt = [d[3] for d in data]
        # print('chat dara')
        # print(char_data)
        ...
        # print("len post data")
        # pos_set = set(pos_data_alt)
        # lens = []
        # for p in pos_set:
        #     lens.append({'w': p, 'c': pos_data_alt.count(p)})
        # print(sorted(lens, key=lambda k: k['c']))
        #
        # print(len(pos_set))
