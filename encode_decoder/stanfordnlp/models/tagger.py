...
def train(args):
    ...
    if args["continue_train"]:
        trainer = Trainer(args=args, vocab=vocab, pretrain=pretrain, use_cuda=args['cuda'], model_file=model_file)
        print(type(trainer.args["dev_score"]))
        total_step = trainer.args['total_step']
    ...
    while True:
        ...
        for i, batch in enumerate(train_batch):
            ...
            if global_step % args['log_step'] == 0:
                ...
                print(format_str.format(datetime.now().strftime("%Y-%m-%d %H:%M:%S"), total_step,\
            ...
            if global_step % args['eval_interval'] == 0:
                ...
                print("step {}: train_loss = {:.6f}, dev_score = {:.4f}".format(total_step, train_loss, dev_score))
                train_loss = 0
                ...
                trainer.args['total_step'] = total_step
                # save best model
                if len(dev_score_history) == 0 or dev_score > max(dev_score_history):
                    last_best_step = total_step
            ...
            if total_step - last_best_step >= args['max_steps_before_stop']:
